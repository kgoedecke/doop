...
function Avatar({
  ...
  return (
    <div
      ...
      {...props}
    >
      <span className={cn('grid place-items-center', isDefaultInk ? 'text-paper' : 'text-white')}>
